...
@focus
Cenario: Realizar testes de mensagens de erro: nome obrigatorio
  Dado que eu acione o botao de Alterar
  Quando preencher os campos alterados com " " e " "
  Dado que eu preencha os dados de nome "nome obrigatorio", email "",senha ""


Cenario: Alterar cadastro
  Dado que eu acione o botao de Alterar
  Quando preencher os campos alterados com "Nome alterado" e "vmoliveira3@ticto.io"
  E valido a mensagem "Usuário salvo com sucesso."
  Entao valido os valores inseridos na GRID
